    ...
    */
    ...
    'connections' => [
        ...
        'pgsql' => [
            ...
            // Supabase pgbouncer (port 6543) uses transaction mode;
            // prepared statements must be disabled to avoid errors.
            'options' => [
        ...
        /*
        | Supabase Postgres — optional SQL fallback / mirror (Project Settings → Database).
        | Use only when SUPABASE_DATABASE_URL is set; point migrations here if DB_FALLBACK=supabase.
        */
        'supabase' => [
            'driver' => 'pgsql',
