...
export const router = createBrowserRouter([
    ...
    // ── Customer ───────────────────────────────────────────────────────────
    {
        ...
        children: [
            ...
            { path: 'my-shipments', element: <CustomerGuard><LogisticsPage /></CustomerGuard> },
            { path: 'documents',    element: <CustomerGuard><DocumentsPage /></CustomerGuard> },
            { path: 'billing',      element: <CustomerGuard><BillingPage /></CustomerGuard> },
            { path: 'support',      element: <CustomerGuard><SupportPage /></CustomerGuard> },
    ...
    { path: '/logistics', element: <Navigate to="/customer/my-shipments" replace /> },
